          ...
          <table>
              ...
              <tr>
                ...
                <th className="w-24">
                  <button
                    ...
                    className="inline-flex items-center gap-1 hover:text-indigo-700 transition-colors duration-300"
                  >
                    Date
            ...
            <tbody>
              {papers.map((paper, index) => (
                <tr
                  key={paper.id}
                  className={`${selected.has(paper.id) ? 'bg-indigo-50/50' : ''} fade-in`}
                  ...
                  <td>
                    <Link
                      ...
                      className={`hover:text-indigo-700 transition-colors duration-300 ${
                        paper.is_read ? 'text-gray-500' : 'text-gray-900 font-medium'
                      }`}
                    >
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">
                      ...
                      {paper.categories?.[0] && (
                        <span className="ml-2 px-2 py-0.5 bg-indigo-100 text-indigo-700 rounded-lg text-[10px]">
                          {paper.categories[0]}
                        </span>
                      )}
                    </p>
        ...
        <div className="flex items-center justify-between fade-in stagger-5">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              disabled={page <= 1}
              className="p-2 glass-card hover:bg-indigo-50 disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-300"
            >
